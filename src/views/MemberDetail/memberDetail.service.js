...
export const fetchMember = id => {
    ...
    const attr = reqAttrQry("attr", ["id", "memberId", "firstname", "lastname", "username", "phone", "weight", "age", "gender", "vaccinated", "addressLine1", "landmark", "image", "referral", "aadhaarNo", "notes", "isAvailable", "isSignup", "joinDate"]);
